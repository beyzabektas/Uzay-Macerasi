...
public class Gezegenler : MonoBehaviour
{
    ...
    void Awake()
    {
        //resources klasorundeki elementlere ulasiriz.
    ...
    {
        //Debug.Log("Gezegen yerlestirilecek");
    ...
    GameObject RandomGezegen()
    {
        ...
        {
            //Ekranimizda olma ihtimali olan 8 gezegen harici diger gezegenlerden bir adet rastgele bize verir
            for (int i = 0; i < 8; i++)
            {
                gezegenler.Add(kullanilanGezegenler[i]);
            }
            // 0'dan basla ve 8 elemani kaldir
